const product_01_image_01 = require("../images/products/1.jpg");
...
const products = [
  ...
  {
    title: "Quần jean phong cách Kingnu",
    price: "194000",
...
const getProductByName = (name) => products.find((e)=>e.includes(name))
...
const getCartItemsInfo = (cartItems) => {
  ...
  // console.log(res.sort((a, b) => a.id > b.id ? 1 : (a.id < b.id ? -1 : 0)))
